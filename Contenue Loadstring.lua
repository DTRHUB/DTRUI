...
function DTR.CreateButton(parent, title, callback)
    local positionY = #parent:GetChildren() * 0.07
...
function DTR.CreateColorPicker(parent, labelText, defaultColor, callback)
    ...
    button.Font = Enum.Font.SourceSansBold
    button.TextSize = 18
    button.Text = labelText .. " (Click to Confirm Color)"
...
function DTR.CreateWatermark()
    if watermarkFrame then return end -- already created
    ...
    watermarkText.Text = "Exemple Script- DTR SCRIPT BY LEVEN | FPS: ??"
